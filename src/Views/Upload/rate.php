...
<div class="forms bg-gray">
    ...
    <form enctype='multipart/form-data' action='<?php echo $view->url('Upload', 'rate');?>' method='post' class="form-inline">
        <input size='50' type='file' name='filename' value='load' class="form-control">
        <input type='submit' name='submit' value='Upload TAUX' class="btn btn-default">
        <span class="control-label">`conversion` update</span>
    </form>
</div>
