...
<div class="forms bg-gray">
    ...
    <form enctype='multipart/form-data' action='<?php echo $view->url('Upload', 'freqHitsScenario');?>' method='post' class="form-inline">
        <input size='50' type='file' name='filename' value='load' class="form-control">
        <input type='submit' name='submit' value='Upload FREQ SCENARIO' class="btn btn-default">
        <span class="control-label">`freq_of_hits_per_scenario`</span>
    </form>
</div>
