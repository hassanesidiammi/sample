...
<div class="forms bg-gray">
    ...
    <form enctype='multipart/form-data' action='<?php echo $view->url('Upload', 'seuil');?>' method='post' class="form-inline">
        <input size='50' type='file' name='filename' value='load' class="form-control">
        <input type='submit' name='submit' value='Upload SEUIL' class="btn btn-default">
        <span class="control-label">`seuil` <small>SCENARIO_VARIABLES.CSV</small></span>
    </form>
</div>
