...
<div class="forms bg-gray">
    ...
    <form enctype='multipart/form-data' action='<?php echo $view->url('Upload', 'scenario');?>' method='post' class="form-inline">
        <input size='50' type='file' name='filename' value='load' class="form-control">
        <input type='submit' name='submit' value='Upload UPDATE SCENARIO' class="btn btn-default">
